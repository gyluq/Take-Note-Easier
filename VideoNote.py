...
"")
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(14, 6, 777, 30))
        ...
        self.textEdit1.setMinimumSize(QSize(300, 25))
        self.textEdit1.setMaximumSize(QSize(300, 25))
        font1 = QFont()
        ...
        self.label_BG.setGeometry(QRect(6, 2, 791, 37))
        font3 = QFont()
