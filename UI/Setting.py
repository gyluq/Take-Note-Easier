...
"")
        ...
        self.gridLayout.addWidget(self.label1_2, 0, 5, 1, 1)

        self.horizontalSpacer_5 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_5, 2, 4, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label1_2.setText(QCoreApplication.translate("Form", u"\u56fe\u7247\u6700\u5927\u5c3a\u5bf8", None))
